 ...
 */
package com.example.rafael.wasterofbattery.batterywasterdemo.sinks;
...
public class MotionSensors extends Sink implements SensorEventListener {
    ...
    private static void initializeSensorNames() {
		...
		if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.KITKAT) {
			SENSORS_NAME.append(Sensor.TYPE_STEP_DETECTOR, "STEP_DETECTOR");
			SENSORS_NAME.append(Sensor.TYPE_STEP_COUNTER, "STEP_COUNTER");
			SENSORS_NAME.append(Sensor.TYPE_GEOMAGNETIC_ROTATION_VECTOR, "GEOMAGNETIC_ROTATION_VECTOR");
		}
    }
