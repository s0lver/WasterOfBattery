 ...
 */
package com.example.rafael.wasterofbattery.batterywasterdemo.views;
...
import com.example.rafael.wasterofbattery.batterywasterdemo.gl.*;
...
public class CustomGLView extends GLSurfaceView {
    ...
    private CustomAnimationCallback mCustomAnimationCallback = new CustomAnimationCallback();
	private class CustomAnimationCallback implements KubeRenderer.AnimationCallback {
	...
	private void init() {
        isPaused = true;
        mRenderer = new KubeRenderer(makeGLWorld(), mCustomAnimationCallback);
